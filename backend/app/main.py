...
DEFAULT_PIPELINE = {
    ...
    "edges": [
        {
            "id": "edge_config_to_architect",
            "source_node_id": "node_domain_config",
            "target_node_id": "node_schema_architect",
            "data_mapping": {},
            "edge_type": "default",
        },
        {
            "id": "edge_struct_to_architect",
        ...
        {
            "id": "edge_architect_to_ontology",
            "source_node_id": "node_schema_architect",
